...
SCHEMA_VERSION = "carlos_rpa.piece_plan.v3.uf1_a_240x96"
...
# Marcaje sin texto: trata TODO el grabado como figuras (sin paso mark_text ni
# E1 fixed). Y un path independiente por figura en vez de un grupo unido.
# Se pueden activar por DXF via entorno sin alterar el flujo por defecto.
MARK_DISABLE_TEXT = _env_flag("MARK_DISABLE_TEXT")
