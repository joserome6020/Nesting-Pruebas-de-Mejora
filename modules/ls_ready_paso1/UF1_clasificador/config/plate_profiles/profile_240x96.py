# -*- coding: utf-8 -*-
"""Reglas específicas — placa 240x96, cama A, R3, UF-1."""
PROFILE_KEY = "240X96"
PLATE_SIZE_IN = "240x96"
STATUS = "active"
DESCRIPTION = (
    "Placa 240x96 cama A: normalización MAX_X/MAX_Y con offset 20 mm, "
    "columnas por anchor de 100 mm, barrenos individuales y mapa E1/J2 A/B/C/D/F."
)
