# -*- coding: utf-8 -*-
"""Bloque de texto exclusivo cama A: inicio en menor X y mayor Y en DXF."""
...
def order_text_strokes(text_strokes, orientation):
    """
    Orden de trazos en coordenadas DXF para cama A, antes de convertir a UF-1:
      vertical   -> Y mayor primero (descending_y).
...
def compute_text_start_point(ordered_text_strokes, orientation):
    """Punto de inicio del path de texto para cama A: menor X y mayor Y en DXF."""
    best = None
    best_key = None
