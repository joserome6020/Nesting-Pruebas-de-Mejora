"""
Inventario cobre (CU): barras largo 144" × 1.75–6" para nesting 1D (cu_largos_nesting).
"""
...
# Barras estándar de cobre en Herinox (incl. SCO028 = 1.75" × 144")
LARGO_CU_LONGITUD_IN = 144.0
LARGO_CU_ANCHO_MIN_IN = 1.75
...
def es_placa_largo_cu(placa: dict) -> bool:
    """True si el stock es barra CU 144\" × 1.75–6\" (lógica largos 1D)."""
...
def inventario_barras_largos_cu(placas_ok: List[dict]) -> List[dict]:
    """Filtra inventario a barras CU 144\"×1.75–6\" (ignora placas comerciales u otros formatos)."""
